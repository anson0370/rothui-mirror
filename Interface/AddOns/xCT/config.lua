...
-- appearence
	...
	["damagefont"] = "Fonts\\DAMAGE.ttf",	 -- "Fonts\\FRIZQT__.ttf" is default WoW damage font
	["damagefontsize"] = "14",	-- size of xCT damage font. use "auto" to set it automatically depending on icon size, or use own value, 16 for example. if it's set to number value icons will change size.
